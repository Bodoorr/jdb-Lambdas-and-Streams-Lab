...
//        list.forEach(item-> System.out.println(item));
    ...
    public void getMaximumPaidEmployee() {
        ...
        Employee highest = this.employees.stream()
                .reduce((employee, employee2) -> employee.getSalary()> employee2.getSalary()? employee:employee2).orElse(null);
         System.out.println(highest);
    }

    public static void main(String[] args) {
    Main print= new Main();
    print.getEmployeesOver50k();
    print.getEmployeeNamesHiredAfter2012();
    print.getMaxSalary();
    print.getMinSalary();
    print.getAverageSalaries();
    print.getMaximumPaidEmployee();
    }
}